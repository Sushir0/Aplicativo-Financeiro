...
import com.example.finance.a_Domain.model.Dados.getMesAbreviados
...
import com.example.finance.a_Domain.model.Dados.ordenarPorAno
import com.example.finance.a_Domain.model.Dados.ordenarPorDia
import com.example.finance.a_Domain.model.Dados.ordenarPorMes
import org.junit.Assert
import org.junit.Test

class DataUnitTest {
    /*
    val categoriaTest = CategoriaDebbug().gerarCategoriaTeste()
    ...
    fun testeDatasFromMovimentacoes(){
        ...
        val movimentacoes = listOf(
            Movimentacao("teste", Data(10, 1,11), 100.0, categoriaTest),
            Movimentacao("teste", Data(15, 2,12), 100.0, categoriaTest),
            Movimentacao("teste", Data(20, 3,13), 100.0, categoriaTest),
        )
    ...
    fun testGetMesesUtilizados(){
        ...
        val movimentacoes = listOf(
        Movimentacao("teste", Data(10, 1,11), 100.0, categoriaTest),
        Movimentacao("teste", Data(15, 2,11), 100.0, categoriaTest),
        Movimentacao("teste", Data(20, 3,11), 100.0, categoriaTest),
        Movimentacao("teste", Data(21, 3,11), 100.0, categoriaTest),
        )
    ...
    fun testGetAnosUtilizados(){
        //Arrange
        val movimentacoes = listOf(
            Movimentacao("teste", Data(10, 1,10), 100.0, categoriaTest),
            Movimentacao("teste", Data(15, 2,11), 100.0, categoriaTest),
            Movimentacao("teste", Data(20, 3,12), 100.0, categoriaTest),
            Movimentacao("teste", Data(21, 3,13), 100.0, categoriaTest),
            Movimentacao("teste", Data(21, 3,13), 100.0, categoriaTest),
        )
        val datas = getDatasDeMovimentacoes(movimentacoes)
